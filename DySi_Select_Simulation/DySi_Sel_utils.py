...
#
# DySi_Sel_utils python module is used for providing helper interfaces for the
# DySi_Select client.
# ==============================================================================
"""
...
# ==============================================================================
# get_args interface is used to read and store the argument from CLI
# 
# Returns: the parsed arguments
# ==============================================================================
def get_args():
    argparser = argparse.ArgumentParser(
        description='CARLA DySi_Select Client')
    ...
    argparser.add_argument(
        ...
        metavar='NAME',
        default='ego-vehicle',
        help='actor role name (default: "ego-vehicle")')
    argparser.add_argument(
        '--fps',
        metavar='FPS',
        default= 30,
